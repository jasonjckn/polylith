...
(deftest lib-imports-src--given-a-lib-with-interface-and-library-imports--return-all-imports-except-libs
  (is (= {:src ["clj-time.coerce"
                ...
                "slugger.core"
                "spec-tools.data-spec"]}
         (lib-imports/lib-imports "clojure.realworld." interface-names lib))))
