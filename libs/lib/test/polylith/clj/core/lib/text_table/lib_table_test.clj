...
(def workspace {:settings {:color-mode "none"
                           :empty-character "."
                           :profile-to-settings {"default" {:paths ["libs/user/src"
                                                                    "libs/user/resources"
                                                                    "libs/user/test"
                ...
                :projects [{:base-names {}
                           ...
                           {:base-names {:src ["cli"]}
                            ...
                            :lib-names {:src ["admin" "database" "invoicer" "purchaser"]}}
                           {:base-names {:src ["cli"]}
                            :is-dev true
                            :name "development"
                            :alias "dev"
                            ...
                            :unmerged {:lib-deps {:src dev-lib-deps
                                                  :test {}}}
                            :lib-names {:src ["address" "database" "invoicer" "purchaser" "user"]}
                            :profile {:lib-deps dev-profile-lib-deps}}]
                :messages []
                :libs [{:lib-deps {:src {"antlr" {:local/root "/Users/tengstrand/.m2/repository/antlr/antlr/2.7.7/antlr-2.7.7.jar"
                                                        :type "local"
                                                        :size 445288
                                                        :version "2.7.7"}}}
                              :name "address"
