...
(defn help [extended? cm]
  (str "  Shows all libraries that are used in the workspace.\n"
       ...
       "                                                                                 " (color/lib "s  t\n" cm)
       "                                                                                 " (color/lib "e  i\n" cm)
       "    library                 version    type      KB   " (s/key "cl   dev  default  admin" cm) (color/lib "   r  l\n" cm)
       "    -----------------------------------------------   --   -------------------   ----\n"
       ...
       "\n"
       "  The " (color/project "x" cm) " in the " (color/lib "user" cm) " column, tells that " (color/library "clj-time" cm) " is used by that lib\n"
