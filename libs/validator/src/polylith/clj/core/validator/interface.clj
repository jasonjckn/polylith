...
(defn validate-ws [suffixed-top-ns settings paths interface-names interfaces libs bases projects config-errors interface-ns user-input color-mode]
  (core/validate-ws suffixed-top-ns settings paths interface-names interfaces libs bases projects config-errors interface-ns user-input color-mode))
