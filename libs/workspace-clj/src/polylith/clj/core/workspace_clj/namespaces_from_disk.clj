...
(comment
  (def source-dir "libs/version/src/polylith/clj/core/")
  (def file-path "libs/tap/src/polylith/clj/core/tap/core.clj")
  (def file-path "libs/tap/src/polylith/clj/core/tap/config.clj")
  (def file-path "libs/file/src/polylith/clj/core/file/testing.clj")
