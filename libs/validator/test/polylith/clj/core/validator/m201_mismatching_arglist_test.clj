...
(def interfaces3 [{:name "auth",
                   ...
                   :implementing-libs ["auth1" "auth2"]}])

(def libs3 [{:name "auth1"
                   :type "lib"
                   :interface {:name "auth"
                               :definitions [{:name "hello", :type "function", :arglist [{:name "x"}]}]}
                   :interface-deps {}}
...
(deftest warnings--when-having-functions-with-the-same-arity-but-with-different-arglists--return-warnings
  (is (= [{:type "warning"
           :code 201
           :colorized-message "Function in the invoice lib is also defined in invoice2 but with a different argument list: func1[a b], func1[x y]"
           :message           "Function in the invoice lib is also defined in invoice2 but with a different argument list: func1[a b], func1[x y]"
           :libs ["invoice" "invoice2"]}
          {:type "warning"
           :code 201
           :colorized-message "Function in the invoice lib is also defined in invoice2 but with a different argument list: func1[a], func1[b]"
           :message           "Function in the invoice lib is also defined in invoice2 but with a different argument list: func1[a], func1[b]"
           :libs ["invoice" "invoice2"]}
          {:type "warning"
           :code 201
           :colorized-message "Function in the user1 lib is also defined in user2 but with a different argument list: func2[a b], func2[x y]"
           :message           "Function in the user1 lib is also defined in user2 but with a different argument list: func2[a b], func2[x y]"
           :libs ["user1" "user2"]}
          {:type "warning"
           :code 201
           :colorized-message "Function in the user1 lib is also defined in user2 but with a different argument list: func3[a b c], func3[x y z]"
           :message           "Function in the user1 lib is also defined in user2 but with a different argument list: func3[a b c], func3[x y z]"
           :libs ["user1" "user2"]}]
         (sort-by :message
                  (m201/warnings interfaces libs color/none)))))
...
(deftest warnings--when-having-macros-with-the-same-arity-but-with-different-argument-lists--return-warnings
  (is (= [{:type "warning"
          ...
          {:type "warning"
           :code 201
           :colorized-message "Macro in the invoice lib is also defined in invoice2 but with a different argument list: sub.macro1[a], sub.macro1[b]"
           :message           "Macro in the invoice lib is also defined in invoice2 but with a different argument list: sub.macro1[a], sub.macro1[b]"
           :libs ["invoice" "invoice2"]}]
         (sort-by :message
                  (m201/warnings interfaces2 libs2 color/none)))))
...
(deftest warnings--when-having-functions-with-the-same-arity-but-with-a-type-hint-in-only-one-of-the-argument-lists--return-warning
  (is (= [{:type "warning"
           :code 201
           :colorized-message "Function in the auth1 lib is also defined in auth2 but with a different argument list: hello[^String x], hello[x]"
           :message "Function in the auth1 lib is also defined in auth2 but with a different argument list: hello[^String x], hello[x]"
           :libs ["auth1" "auth2"]}]
         (sort-by :message
                  (m201/warnings interfaces3 libs3 color/none)))))
