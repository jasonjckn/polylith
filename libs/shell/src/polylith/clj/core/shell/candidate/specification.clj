...
(def interface-value (c/multi-arg :create-lib "interface"))
(def interface (c/multi-param "interface" 2 (c/group :create-lib) (c/optional) [interface-value]))
(def create-lib-name-value (c/multi-arg :create-lib "name"))
(def create-lib-name (c/multi-param "name" 1 (c/group :create-lib) [create-lib-name-value]))
(def create-lib (c/single-txt "lib" :create-lib [create-lib-name interface]))
...
(defn create [current-ws? all?]
  (when current-ws?
    (c/single-txt "create" :create
      (concat [create-base create-lib create-project]
...
(def help-create-lib (c/single-txt "lib"))
(def help-create-project (c/single-txt "project"))
(def help-create-workspace (c/single-txt "workspace"))
(def help-create (c/single-txt "create" [help-create-base help-create-lib help-create-project help-create-workspace]))
