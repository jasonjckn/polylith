...
(deftest diff--when-comparing-two-hashes--return-changes
  (is (= ["libs/workspace-clj/src/polylith/clj/core/workspace_clj/non_top_namespace.clj"
          "libs/workspace-clj/test/polylith/clj/core/workspace_clj/non_top_namespace_test.clj"
