...
(defn project-deps [libs bases lib-names-src lib-names-test base-names-src base-names-test suffixed-top-ns brick-names-to-test]
  (project-brick-deps/project-deps libs bases lib-names-src lib-names-test base-names-src base-names-test suffixed-top-ns brick-names-to-test))
