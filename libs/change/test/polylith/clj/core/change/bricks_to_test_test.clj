...
(deftest project-to-bricks-to-test--with-one-changed-lib--returns-bricks-to-test-for-changed-projects
  (is (= {"core" ["article"]
          "development" []}
         (test {:changed-projects []
                :settings {}
                :changed-libs ["article"]
                :changed-bases []
                :project-to-indirect-changes {}
                :selected-bricks nil
                :selected-projects #{}
...
(deftest project-to-bricks-to-test--with-one-changed-lib-that-is-excluded---returns-bricks-to-test-for-changed-projects
  (is (= {"core" []
          "development" []}
         (test {:changed-projects []
...
(deftest project-to-bricks-to-test--include-two-bricks--returns-the-two-bricks
  (is (= {"core" ["tag"
         ...
         (test {:changed-projects []
                ...
                :changed-libs ["article" "comment" "rest-api" "tag" "user"]
                :changed-bases []
                :project-to-indirect-changes {}
                :selected-bricks nil
                :selected-projects #{}
...
(deftest project-to-bricks-to-test--with-two-changed-libs-and-one-selected-brick--returns-selected-bricks-that-are-also-changed
  (is (=
        {"core" ["user"]
         "development" []}
        (test {:changed-projects []
               :settings {}
               :changed-libs ["article" "user"]
               :changed-bases []
               :project-to-indirect-changes {}
...
(deftest project-to-bricks-to-test--with-no-changed-libs-and-one-selected-brick--returns-no-bricks
  (is (= {"core" []
          "development" []}
         (test {:changed-projects []
                :settings {}
...
(deftest project-to-bricks-to-test--with-no-changed-libs-and-one-selected-brick-with-run-all-brick-tests--returns-selected-brick
  (is (= {"core" ["tag"]
          "development" []}
         (test {:changed-projects []
                :settings {}
