(ns ^:no-doc polylith.clj.core.help.create
  (:require [polylith.clj.core.common.interface :as common]
            ...
            [polylith.clj.core.help.create-lib :as lib]
...
(defn help-text [cm]
  (str "  Creates a lib, base, project or workspace.\n"
       "\n"
       "  poly create " (s/key "TYPE" cm) " [" (s/key "ARGS" cm) "]\n"
       "\n"
       "    " (s/key "TYPE" cm) " = " (s/key "c[omponent]" cm) " -> Creates a lib.\n"
